...
public class Ax12 {
    ...
    private static GpioPinDigitalOutput RPI_DIRECTION_PIN_TX; 
    private static GpioPinDigitalOutput RPI_DIRECTION_PIN_RX;
    private static double RPI_DIRECTION_SWITCH_DELAY = 0.00001;
   
    // static variables
    private static int port = Serial.serialOpen(Serial.DEFAULT_COM_PORT, 115200);
    ...
    public Ax12(long baudrate,int rpiDirSwitch){
        ...
        //this.RPI_DIRECTION_PIN_TX = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_15); //PORTAS RELACIONADAS PI4J
